...
#view the rows and cols, change according to the cols you will be testing in the next step
...
#contingency_table=pd.crosstab(data.age, data.target, margins=True)
#contingency_table=pd.crosstab(data.sex, data.target, margins=True)
#contingency_table=pd.crosstab(data.exang, data.target, margins=True)
...
#results:
    #ca, thal- fail to reject H0
    #fbs, target- fail to reject H0
    #age, thal- reject H0
    #restecg, exang- reject H0
    #exang, target- reject H0
    #age, target- reject H0
    #sex, target- reject H0